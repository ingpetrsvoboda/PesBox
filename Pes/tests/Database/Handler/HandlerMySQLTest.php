...
class AttributesProviderForTest extends AttributesProviderDefault {
    ...
    public function getAttributesArray() {
        ...
        $attributes[\PDO::ATTR_STATEMENT_CLASS] = array(self::BASE_STATEMENT_TYPE,  array());  // bez loggeru
        return $attributes;        
    }
}
...
class HandlerMySQLTest extends TestCase {
    ...
    public function testHandlerForMysql() {
        ...
        $connectionInfoWin = new ConnectionInfo(self::NICK, DbTypeEnum::MySQL, self::DB_HOST, self::USER, self::PASS, self::DB_NAME, self::CHARSET_WINDOWS, self::COLLATION_WINDOWS, self::DB_PORT);
