...
class ConnectionInfoTest extends TestCase {
    ...
    public function testConnectionInfo() {
        $connectionInfo = new ConnectionInfo(self::NICK, DbTypeEnum::MySQL, self::DB_HOST, self::USER, self::PASS, self::DB_NAME, self::CHARSET_UTF8, self::COLLATION_UTF8, self::DB_PORT); 
