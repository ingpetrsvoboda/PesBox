...
interface ConnectionInfoInterface {
    /**
     * @return string Přezdívka databáze
     */
    ...
    /**
     * @return string Jméno uživatele pro přihlášení
     */
    public function getUser();
    
    // Metoda getPass() neexistuje z bezpečnostních důvodů!
    /**
     * @return string Heslo pro přihlášení
     */
