...
use Pes\Http\UriExtendInterface;
 ...
 */
class RequestPsr extends Message implements ServerRequestInterface
{
    /**
     * The request method
     *
    ...
    public static function createFromEnvironment(Environment $environment)
    {
        ...
        $request = new static($method, $uri, $headers, $cookies, $environment, $body, $uploadedFiles);
    ...
    public function __construct(
        ...
        $this->serverParams = $environment->getArrayCopy();
        $this->attributes = new MapCollection();
        $this->body = $body;
