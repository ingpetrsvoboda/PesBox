 ...
 */
abstract class ResponsePsr extends Message implements ResponseInterface
{
    /**
     * Status code
     *
    ...
    public function __clone()
    {
        ...
        // Zde se neklonuje se se objekt Body, protože to je objekt Stream a ten obsahuje vnitřně PHP stream, ten vnitřní PHP 
        // stream se neklonuje a klonovat objekt Stream při každém klonování je tak zbytečné - navíc to způsobuje chybu, pokud se stream klonuje, 
        // ale původní stream obsažený v Response před klonováním je destruován - naklonovaný stream zůstane, ale vznikají chyby - viz https://github.com/slimphp/Slim/issues/1860
        // Poznámka - v Requestu se v __clone kopíruje body (ale tam to je RequestBody (potomek Body)) funkcí stream_copy_to_stream().
