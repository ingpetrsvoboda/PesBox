 ...
 * (pro přístup k řádkovým objektům db tabulky faktura) a pro přístup k datům položem již existující repository pro položky.
 * 
 * Repository "hovoří" jazykem domény. Například má repository pro faktury metodu vracející neuhrazené faktury getOutstanding(). To je jazyk domény, 
