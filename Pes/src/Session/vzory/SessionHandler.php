...
class SessionHandler extends \SessionHandler {
    ...
    protected $key, $name, $sessionCookieParams;

    public function __construct($key, $sessionName = self::SESSION_NAME, array $sessionCookieParams = [])
    {
        $this->key = $key;
...
//    }
    ...
    {
        return ! $this->isExpired() && $this->hasFingerprint();
    }
