...
/**
 * Bootstrap 
 * Počáteční nastavení prostředí, error a exception handlerů, auloloderu
 */
...
$GLOBALS['development'] = function () { return getenv('development'); };  // Windows - musí být nastavena systémová (nestačí uživatelská) proměnná prostředí development (case insensitive)
$GLOBALS['production'] = function () { return getenv('production'); };  // Windows - musí být nastavena systémová (nestačí uživatelská) proměnná prostředí production (case insensitive)
